return {
  ...
  keys = {
    ...
    -- { '<Space>a', [[:lua require('harpoon.ui').nav_file(4)<CR>]], { silent = true }, desc = 'Harpoon M4' },
    -- { '<Space>,', [[:lua require('harpoon.ui').nav_file(5)<CR>]], { silent = true }, desc = 'Harpoon M5' },
    { '<bs>c', [[:lua require('harpoon.ui').nav_file(1)<CR>]], { silent = true }, desc = 'Harpoon M1' },
    { '<bs>i', [[:lua require('harpoon.ui').nav_file(2)<CR>]], { silent = true }, desc = 'Harpoon M2' },
    { '<bs>e', [[:lua require('harpoon.ui').nav_file(3)<CR>]], { silent = true }, desc = 'Harpoon M3' },
    { '<bs>a', [[:lua require('harpoon.ui').nav_file(4)<CR>]], { silent = true }, desc = 'Harpoon M4' },
    { '<bs>,', [[:lua require('harpoon.ui').nav_file(5)<CR>]], { silent = true }, desc = 'Harpoon M5' },
    {
      ',c',
