...
ls.config.set_config({
  ...
  history = true,
  -- updateevents: Choose which events trigger an update of the active nodes' dependents.
  updateevents = 'InsertLeave', 'TextChanged,TextChangedI',
  -- region_check_events: Events on which to leave the current snippet if the cursor is outside its' 'region'.
  -- Disabled by default, 'CursorMoved', 'CursorHold' or 'InsertEnter' seem reasonable.
  region_check_events = 'CursorMoved',
  -- delete_check_events: When to check if the current snippet was deleted, and if so, remove it from the history.
  -- Off by default, 'TextChanged' (perhaps 'InsertLeave', to react to changes done in Insert mode
  delete_check_events = 'TextChanged',
  -- enable_autosnippets: Autosnippets are disabled by default to minimize performance penalty if unused.
  enable_autosnippets = true,
  -- ext_opts: Additional options passed to extmarks. Can be used to add passive/active highlight on a per-node-basis.
  ext_opts = {
    -- [types.choiceNode] = {
      -- 	active = {
