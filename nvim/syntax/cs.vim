...
" Maintainer:           Mathijs Bakker (https://github.com/Mathijs-Bakker)
" Former Maintainers:    Anduin Withers (awithers@anduin.com), Kian Ryan (kian@orangetentacle.co.uk)
" Filenames:            *.cs
"
" REFERENCES:
...
" group-name type
syn keyword csType			bool byte char decimal double float int
syn keyword csType			long sbyte short string uint 
syn keyword csType			uint ulong ushort void var dynamic

" group-name storage
syn keyword csReferenceType             class interface delegate nextgroup=csClass skipwhite
syn keyword csStructure                 struct nextgroup=csClass skipwhite

" group-name repeat  label
syn keyword csIterationStatement        do for foreach while
syn keyword csJumpStatement		break continue default goto return yield
syn keyword csSelectionStatement	if else switch case
...
" modifier
syn keyword csModifier	abstract const extern internal override nextgroup=CsClass,CsIface skipwhite
syn keyword csModifier	private protected public readonly sealed nextgroup=CsClass,CsIface skipwhite
syn keyword csModifier	static virtual volatile nextgroup=CsClass,CsIface skipwhite
...
"New Declarations
syn keyword csNewDeclaration            new nextgroup=csClass skipwhite
...
syn region csEnclosed start="(" end=")" contains=csConstant,csType,csString, csVerbatimString, csCharacter, csNumber,csIface,csClass,csNewDeclaration,csUnspecifiedStatement,csLinq
...
hi def link csReferenceTypeDeclaration	StorageClass
hi def link csInterfaceDeclaration      StorageClass
hi def link csNewDeclaration            StorageClass
hi def link csStorage			StorageClass
hi def link csIterationStatement        Repeat 
hi def link csJumpStatement		Repeat
hi def link csSelectionStatement	Conditional
